...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_map__ = __webpack_require__(485);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_map___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_map__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_delay__ = __webpack_require__(487);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_delay___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_delay__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rxjs_add_operator_catch__ = __webpack_require__(490);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_observable_throw__ = __webpack_require__(483);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__angular_fire_auth__ = __webpack_require__(513);
...
let MyApp = class MyApp {
    constructor(alertCtrl, platform, statusBar, splashScreen, db, fireStorage, userservice, loadingCtrl, db2) {
        this.alertCtrl = alertCtrl;
    ...
    chooseFile(event) {
        if (event.target.files[0].size < 390900) {
            ...
            let alert = this.alertCtrl.create({
                title: '<font color="green"><b> </b> The file should be less then 301KB </font>',
                cssClass: "alert",
                buttons: [
                    {
                        text: 'Ok',
    ...
    async uploadFile(user) {
        if (this.selectedFile) {
            ...
            (await this.task).ref.getDownloadURL().then(url => {
                ...
                this.db2.list('photoalbum/users')
                    .push(user)
                    .then((snapshot) => {
                    let alert2 = this.alertCtrl.create({
                        title: '<font color="green"><b> </b>Upload Successful Your unique ID = <font color="black">' + snapshot.key + '</font></font>',
                        cssClass: "alert",
                        buttons: [
                            {
                                text: 'Ok',
    ...
    error() {
        let alert = this.alertCtrl.create({
            title: '<font color="green"><b> </b> Full Name, State, LGA & Address are not optional  </font>',
            cssClass: "alert",
            buttons: [
                {
                    text: 'Ok',
    ...
    removeFile() {
        ...
        if(this.downloadableURL) {
          this.storage.ref(this.filepath2).delete()
        }
