...
let MyApp = class MyApp {
    ...
    error() {
        let alert = this.alertCtrl.create({
            title: '<font color="green"><b> </b> Full Name, State, LGA, PhoneNo & Address are not optional  </font>',
            cssClass: "alert",
            buttons: [
                {
                    text: 'Ok',
