...
let MyApp = class MyApp {
    constructor(alertCtrl, platform, statusBar, splashScreen) {
        this.alertCtrl = alertCtrl;
        this.platform = platform;
        this.statusBar = statusBar;
        this.splashScreen = splashScreen;
        this.user = {};
        // navParent : NavController= this.nav.;
...
MyApp = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\Abdulqadir\Desktop\Ionic_Mobile_App_Builder_v18.12.10\ionic2\PHOTO_ALBUM - Copy\src\app\app.html"*/' <ion-nav #myNav  [root]="rootPage"></ion-nav>\n\n  \n\n\n\n  <!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n\n\n\n'/*ion-inline-end:"C:\Users\Abdulqadir\Desktop\Ionic_Mobile_App_Builder_v18.12.10\ionic2\PHOTO_ALBUM - Copy\src\app\app.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* Platform */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_status_bar__["a" /* StatusBar */], __WEBPACK_IMPORTED_MODULE_3__ionic_native_splash_screen__["a" /* SplashScreen */]])
], MyApp);
